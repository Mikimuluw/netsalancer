...
const STEPS = [
  ...
  {
    num: "06",
    title: "Update Your Client Payment Details",
    am: "\u12E8\u12AD\u134D\u12EB \u1218\u1228\u1303\u12CE\u1295 \u12EB\u12D8\u121D\u1291",
    body: "Log into Upwork, Fiverr, Toptal, or wherever you receive payments. Update your withdrawal method to your new Ethiopian bank account. Your earnings now land directly \u2014 legally, in your name, with full bank statement history from day one.",
    docs: [],
    note: "\u2192 Every payment after this builds your visa application.",
    noteColor: "var(--amber-lt)",
    noteWeight: true,
    blue: true,
  },
